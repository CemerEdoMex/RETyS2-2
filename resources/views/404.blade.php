<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('css/404v.css') }}">
    <title>404</title>
...
<div class="container">
    <div class="copy-container center-xy" id="copy-container">
      ...
      <a href="https://retys.edomex.gob.mx">Vuelve al retys y ya no intentes cosas malas.</a>
  ...
  <script src="{{ secure_asset('js/404v.js') }}"></script>
