...
<div class="container text-center justify-content-center">
    ...
    <div class="row mb-4">
        ...
        @foreach ($data as $item)
            ...
            @if ($item->ambito == 3) 
                <div class="estatal card border-success mb-5 text-center justify-content-center" style="display:block; max-width: 20rem; min-width: 20rem;">
                @elseif ($item->ambito == 4)
                <div class="municipal card border-primary mb-5 text-center justify-content-center " style="display:block; max-width: 20rem; min-width: 20rem;">
                @elseif($item->ambito == 5)
                <div class="federal card border-secondary mb-5 text-center justify-content-center" style="display:block; max-width: 20rem;">
                @else
